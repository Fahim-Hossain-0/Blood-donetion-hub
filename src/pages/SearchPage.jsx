  ...
  return (
    <div className="max-w-3xl mx-auto mt-10 bg-white p-8 rounded-xl shadow-xl">
      ...
      <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <button
          type="submit"
          className="btn bg-gradient-to-r from-green-500 to-green-700 text-white mt-2 col-span-1 md:col-span-2"
        >
          Search
        </button>
      </form>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {donors.map((donor) => (
              <div key={donor._id} className="card bg-base-100 shadow-md p-5 rounded-lg">
                <h3 className="text-xl font-bold text-green-600">{donor.name}</h3>
